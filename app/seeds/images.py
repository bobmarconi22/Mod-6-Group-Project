...
def seed_images():
    images = [
        ...
        Image(user_id=1, shop_id=1, img_link='http://example.com/shop1_owner_additional1.jpg', preview_image=False),
        Image(user_id=1, shop_id=1, img_link='http://example.com/shop1_owner_additional2.jpg', preview_image=False),

        # Shop 2
        Image(user_id=2, shop_id=2, img_link='http://example.com/shop2_owner_preview.jpg', preview_image=True),
        Image(user_id=4, shop_id=2, review_id=4, img_link='http://example.com/shop2_review1.jpg', preview_image=False),
        ...
        # Shop 3
        Image(user_id=3, shop_id=3, img_link='http://example.com/shop3_owner_preview.jpg', preview_image=True),
        Image(user_id=7, shop_id=3, review_id=7, img_link='http://example.com/shop3_review1.jpg', preview_image=False),
        ...
        # Shop 4
        Image(user_id=4, shop_id=4, img_link='http://example.com/shop4_owner_preview.jpg', preview_image=True),
        ...
        # Shop 5
        Image(user_id=5, shop_id=5, img_link='http://example.com/shop5_owner_preview.jpg', preview_image=True),
        ...
        # Shop 6
        Image(user_id=6, shop_id=6, img_link='http://example.com/shop6_owner_preview.jpg', preview_image=True),
        ...
        # Shop 7
        Image(user_id=7, shop_id=7, img_link='http://example.com/shop7_owner_preview.jpg', preview_image=True),
        ...
        # Shop 8
        Image(user_id=8, shop_id=8, img_link='http://example.com/shop8_owner_preview.jpg', preview_image=True),
        ...
        # Shop 9
        Image(user_id=9, shop_id=9, img_link='http://example.com/shop9_owner_preview.jpg', preview_image=True),
        ...
        # Shop 10
        Image(user_id=10, shop_id=10, img_link='http://example.com/shop10_owner_preview.jpg', preview_image=True),
