...
def seed_reviews():
    reviews = [
        ...
        Review(user_id=16, shop_id=1, review='Nice place to read a book while sipping coffee.', rating=4),
        ...
        Review(user_id=20, shop_id=3, review='Good place to work with a laptop.', rating=4),
        Review(user_id=29, shop_id=3, review='Great coffee shop for a quick break.', rating=4),
        ...
        Review(user_id=21, shop_id=4, review='Nice decor and comfortable seating.', rating=4),
        Review(user_id=22, shop_id=4, review='A bit noisy during peak hours.', rating=3),
        Review(user_id=30, shop_id=4, review='Good place for a casual meeting.', rating=4),
        ...
        Review(user_id=23, shop_id=5, review='Amazing flavors and great service.', rating=5),
        Review(user_id=24, shop_id=5, review='Friendly staff and cozy ambiance.', rating=4),
        Review(user_id=25, shop_id=5, review='The desserts are a perfect complement.', rating=5),
        Review(user_id=26, shop_id=5, review='Highly recommend their seasonal specials.', rating=5),
        ...
        Review(user_id=25, shop_id=7, review='The pastries are very fresh.', rating=4),
        Review(user_id=26, shop_id=7, review='Comfortable seating and good Wi-Fi.', rating=5),
        Review(user_id=27, shop_id=7, review='The staff is very knowledgeable.', rating=5),
        Review(user_id=28, shop_id=7, review='Great place for an afternoon break.', rating=4),
        Review(user_id=29, shop_id=7, review='Love their cold brews.', rating=5),
        ...
        Review(user_id=27, shop_id=8, review='The latte art is beautiful.', rating=4),
        Review(user_id=28, shop_id=8, review='Perfect spot for people watching.', rating=4),
        ...
        Review(user_id=30, shop_id=9, review='A bit crowded but worth it.', rating=3),
        ...
        Review(user_id=31, shop_id=10, review='Great place to catch up with friends.', rating=4),
        Review(user_id=32, shop_id=10, review='Their cappuccinos are the best.', rating=5),
        Review(user_id=33, shop_id=10, review='Love their breakfast options.', rating=4)
    ]
